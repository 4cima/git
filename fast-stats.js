...
console.log('🔍 البيانات الفعلية - ' + new Date().toLocaleString('ar-SA'));
console.log('═'.repeat(80));

const queries = [
  { label: '🎬 أفلام - إجمالي', sql: 'SELECT COUNT(*) as c FROM movies' },
  ...
  { label: '📺 مسلسلات - إجمالي', sql: 'SELECT COUNT(*) as c FROM tv_series' },
