...
import { YEARS, RATINGS, COUNTRIES, MOVIE_SORT_OPTIONS as SORT_OPTIONS,
...
export function MoviesPageClient({ initialMovies = [], initialHasMore = false, forcedLanguage, title, langCode, langLabel }: MoviesPageClientProps) {
  ...
  useEffect(() => {
    ...
    /* تخطي الجلب الأول فقط (مرة واحدة عبر ref): بيانات الـSSR جاهزة ولا توجد فلاتر نشطة أو إعادة محاولة.
       الحارس كان بلا ref فيتخطى أي جلب لاحق تعود فيه الحالة للافتراضي — نفس منطق صفحات التصنيفات. */
