        ...
        <div className="max-w-[1920px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 mr-1">
            ...
            <button
              ...
              className="h-9 px-2.5 bg-cyan-700/95 hover:bg-cyan-600/95 backdrop-blur-sm border border-cyan-500/50 hover:border-cyan-400 rounded-md shadow-lg transition-all duration-300 text-cyan-300 hover:text-white"
              aria-label="القائمة"
            >
              <Menu size={22} />
            </button>
