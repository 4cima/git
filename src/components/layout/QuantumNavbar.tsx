        ...
        <div className="max-w-[1920px] mx-auto px-1 sm:px-2 md:px-3 lg:px-4 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 mr-1">
            ...
            <button
              ...
              className="h-9 px-1 bg-slate-700/95 hover:bg-slate-600/95 backdrop-blur-sm border border-slate-500/50 hover:border-slate-400 rounded-md shadow-lg transition-all duration-300 text-slate-300 hover:text-white"
              aria-label="القائمة"
            >
              <Menu size={22} />
            </button>
