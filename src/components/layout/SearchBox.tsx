    ...
    <div ref={searchRef} className="relative flex items-center gap-3">
      ...
      {!isOpen && !isCollapsed && (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="relative h-9 px-0 bg-slate-700/95 hover:bg-slate-600/95 backdrop-blur-sm border border-slate-500/50 hover:border-slate-400 rounded-md shadow-lg transition-all duration-300 group overflow-hidden"
      ...
      {!isOpen && (
        <motion.button
          ...
          animate={{
            ...
            paddingLeft: isCollapsed ? '9px' : '0px',
            paddingRight: isCollapsed ? '9px' : '0px',
          }}
