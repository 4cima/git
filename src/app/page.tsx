...
/**
 * سكيليتون الصفحة الرئيسية (كان loading.tsx جذرياً — أُزيل لأن حدود Suspense
 * الجذرية تجبر Next على بث 200 قبل حل notFound() في صفحات التفاصيل فيفسد الـ404).
 * بقي هنا فقط كـ fallback داخل حدود Suspense خاصة بالرئيسية (لا تُرجع 404 أبداً).
 */
