...
const OPERATIONS: Record<string, Operation[]> = {
  'Core Workflow': [
    ...
    { id: 'sync', name: 'Sync to D1', command: 'npm run sync', risk: 'medium', description: 'Sync completed content from local.db → Cloudflare D1' },
    { id: 'full-workflow', name: 'Full Workflow', command: 'npm run full-workflow', risk: 'medium', description: 'Run all steps in sequence (download → fetch → sync to D1)' },
