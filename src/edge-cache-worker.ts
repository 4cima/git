 ...
 *   - ⚠️ Cache API بتكلاود فلير بتتجاهل Vary تمامًا (مطابقة بالـURL بس) — عشان كده طلبات
 *     راوتر Next (RSC/prefetch) بتتعدي من غير تخزين، والمخزّن HTML حصريًا (حادثة 18/9:
 *     رد RSC اتخزن مكان صفحة = صفحات فاضية بـJSON خام للزوار، اتصلحت في 4beba90).
