/**
 * Measure query performance AFTER removing "OR filter_status IS NULL"
 * This should allow SQLite to use the optimized partial indexes
 */
...
async function measureQueries() {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
  console.log('  قياس بعد إزالة "OR filter_status IS NULL"')
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')
  ...
  console.log(`   قبل: 418311ms تسلسلي / 171776ms متوازي`)
  console.log(`   بعد: ${d1 + d2 + d3 + d4 + d5}ms تسلسلي / ${dParallel}ms متوازي`)
  console.log(`   التحسين: ${Math.round((1 - dParallel / 171776) * 100)}%`)
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
