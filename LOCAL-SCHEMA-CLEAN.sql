...
BEGIN
  INSERT INTO movies_fts(rowid, title_ar, title_en) VALUES (new.tmdb_id, new.title_ar, new.title_en);
END;

CREATE TRIGGER IF NOT EXISTS movies_fts_delete AFTER DELETE ON movies
BEGIN
  INSERT INTO movies_fts(movies_fts, rowid, title_ar, title_en) VALUES ('delete', old.tmdb_id, old.title_ar, old.title_en);
END;
...
BEGIN
  INSERT INTO series_fts(series_fts, rowid, name_ar, name_en) VALUES ('delete', old.tmdb_id, old.name_ar, old.name_en);
END;
