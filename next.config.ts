    ...
    return [
      ...
      // (a broader enforcing CSP would break ad networks).
      {
        ...
        headers: [
          ...
          // n6wxm.com — ملفات توصيل مونتاج (Vignette 11699162 / In-Page Push 11699161).
          {
            key: 'Content-Security-Policy-Report-Only',
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' https://professionalsusceptible.com https://al5sm.com https://www.highrevenueformat.com https://highrevenueformat.com https://hilltopads.net https://*.hilltopads.net https://hilltopads.com https://sadpicture.com https://conventionalresponse.com https://elementarywhole.com https://n6wxm.com; script-src-elem 'self' 'unsafe-inline' https://professionalsusceptible.com https://al5sm.com https://www.highrevenueformat.com https://highrevenueformat.com https://hilltopads.net https://*.hilltopads.net https://hilltopads.com https://sadpicture.com https://conventionalresponse.com https://elementarywhole.com https://n6wxm.com; img-src 'self' data: blob: https://image.tmdb.org https://play-lh.googleusercontent.com https://upload.wikimedia.org https://assets-global.website-files.com; style-src 'self' 'unsafe-inline'; font-src 'self' data:; connect-src 'self'; frame-src 'self' https://professionalsusceptible.com https://hilltopads.net https://*.hilltopads.net https://conventionalresponse.com https://n6wxm.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self'",
          },
        ],
      },
